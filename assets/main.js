...
window.onload = async function () {
	...
	const addMessage = (data) => {
		...
		if (data.hasOwnProperty("reply-parent-msg-id")) {
			...
			reply.innerHTML = `
			<svg type="color-fill-current" width="17px" height="17px" version="1.1" viewBox="0 0 16 16" x="0px" y="0px">
				<g>
			...
			Respondendo a <span class="reply-parent-user">@${data["reply-parent-display-name"] || data["reply-parent-user-login"]}</span>:
